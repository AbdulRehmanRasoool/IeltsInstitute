...
<body class="carousel-elements">
                ...
                <aside class="sub-banner text-center">
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="active">IELTS Writing Samples</li>
                        </ol>
                        <h1>IELTS Writing samples</h1>
                    </div>
                    <!--sub-banner-->
                </aside>
                <!--row-->
    ...
    <div class="col-lg-12" style="margin: 100px 0px ;">
        <div id="myCarouselV" class="carousel thumbnail">
            <div class="carousel-inner">
                ...
                <div class="item">
                    <div class="carousel-caption">
                        <h4 style="font-weight: 600;">Ifirah Sultana</h4>
                        <h4 style="font-weight: bold;color: #c13c3c;padding-top:10px;">Band Score: 7.5</h4>
                ...
                <div class="item">
                    <div class="carousel-caption">
                        <h4 style="font-weight: 600;">Razia</h4>
                ...
                <div class="item">
                    <div class="carousel-caption">
                        <h4 style="font-weight: 600;">Nimrah Sheikh 
                        </h4>
                        <h4 style="font-weight: bold;color: #c13c3c;padding-top:10px;">Band Score: 7.0</h4>
                ...
                <div class="item">
                    <div class="carousel-caption">
                        <h4 style="font-weight: 600;">Syed Wasi Hyder,
                        </h4>
                        <h4 style="font-weight: bold;color: #c13c3c;padding-top:10px;">Band Score: 7.0</h4>
...
<!-- Mirrored from html.designingmedia.com/Master/carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jul 2024 11:15:33 GMT -->
